<template>
  <div>
    <div class="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
      <div
        ...
        <div class="w-full md:w-1/2">
          <div class="mb-10 lg:mb-20">
            <!-- <svg id="logoipsum" xmlns="http://www.w3.org/2000/svg" viewBox="15 30 147.778 40" class="w-48">
              ...
              <path
                ...
                fill="#0582C1" />
              <path d="M98.861,43.556a1.782,1.782,0,1,1,1.782,1.782A1.8,1.8,0,0,1,98.861,43.556Zm.3,2.653h2.971v9.9H99.157Z" fill="#0582C1" />
              <path
          ...
          <div class="mb-10 md:mb-20 text-gray-600 font-light">
            <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">您訪問的頁面存在</h1>
          </div>
      ...
      <div
        class="w-64 md:w-96 h-96 md:h-full bg-blue-200 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform"></div>
