    ...
    <el-row>
      <el-col :span="24">
        <el-card>
          <el-row>
            <el-col :span="6">
              <el-button type="primary" style="width: 258.25px; height: 42px" @click="add">
                創建新的事件</el-button
              >
              <div>
                <br />
              ...
              <div style="text-align: left">
                <el-checkbox v-model="checked" label="remove after drop" size="large"></el-checkbox>
              </div>
              <div style="text-align: left">
                <el-checkbox
                  ...
                  size="large"
                  @change="handleWeekendsToggle"></el-checkbox>
              </div>
            </el-col>
            <el-col :span="18">
...
import FullCalendar, { CalendarApi, EventApi } from '@fullcalendar/vue3'
import type { CalendarOptions, DateSelectArg, EventClickArg } from '@fullcalendar/vue3'
...
import { INITIAL_EVENTS, createEventId } from './calendar'
...
const add = () => {
  ;(calendarRef.value?.getApi() as CalendarApi).addEvent({
    title: '123',
    start: '2022-11-12',
    id: '123',
  })
