      ...
      <div
        ...
        <div class="w-full md:w-1/2">
          ...
          <div class="mb-10 md:mb-20 text-gray-600 font-light">
            <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">您訪問的頁面不存在</h1>
          </div>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
            ...
            <g id="OBJECTS">
              ...
              <g>
                ...
                <ellipse transform="rotate(-9.249 191.082 198.565)" class="st6" cx="191.05" cy="198.49" rx="9.23"
                  ry="9.23" />
                <path class="st4"
                ...
                <ellipse transform="rotate(-9.249 292.07 198.575)" class="st6" cx="292.01" cy="198.49" rx="9.23"
                  ry="9.23" />
                <path class="st4"
